function [indexA, latA, lonA, altA, headA, rollA] = stringifyILLAHR(index, lat, lon, alt, head, roll)

indexA = ['[' num2str(index(1))];
for i=2:size(index) indexA = [indexA ',' num2str(index(i)')]; end
indexA = [indexA ']'];
