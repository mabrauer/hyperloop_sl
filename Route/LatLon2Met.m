...
% Determine conversion at everage latitude
lat2met = interp1(LatLon2Met.Lat,LatLon2Met.Lat2Met,mean(lat));
lon2met = interp1(LatLon2Met.Lat,LatLon2Met.Lon2Met,mean(lat));
